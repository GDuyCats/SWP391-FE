        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="bg-white/80 backdrop-blur-sm shadow-xl rounded-3xl p-8 border border-gray-100">
            ...
            <div className="space-y-4">
              <Row label="Giá trị xe" value="150.000.000đ" />
              <Row label="Phí sang tên chủ sở hữu" value="300.000đ" />
              <Row label="Phí công chứng hợp đồng" value="500.000đ" />
              <Row label="Phí hồ sơ giấy tờ" value="200.000đ" />
