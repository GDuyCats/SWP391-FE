    ...
    return (
      ...
      <div className="bg-white rounded-xl shadow-xl w-full max-w-3xl p-6 relative">
        ...
        {loading ? (
            ...
            <table className="min-w-full divide-y divide-gray-200">
              <thead className="bg-gray-50">
                <tr>
                  ...
                  <th className="px-4 py-2 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Người Yêu Cầu</th>
          ...
          <div className="text-center text-gray-500 py-6">Không có người yêu cầu nào</div>
        )}
      </div>
    </div>
    );
